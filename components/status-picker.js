  ...
  #render(){
    ...
    s.innerHTML = `
      <style>
        ...
        /* menu: większe odstępy + szary pasek (hover całego wiersza) */
        .menu{min-width:260px;display:flex;flex-direction:column;gap:1rem;padding:.25rem}
        .item{
          display:flex;justify-content:center;align-items:center;
          padding:.5rem .6rem;border-radius:10px;cursor:pointer;transition:background-color .12s ease
        }
